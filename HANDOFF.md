...
- Создан [`LAYER-1/state-transitions.md`](./LAYER-1/state-transitions.md) — политика переходов с колонкой Domain (Project / Session / Task), Illegal Transitions и правилами агента; синхронизация с [`LAYER-3/STATE.md`](./LAYER-3/STATE.md).
