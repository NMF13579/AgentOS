...
## Purpose
Reusable prompt pack for Codex sessions working under AgentOS contracts.

## Use This Prompt When
Use this when Codex is used for bounded implementation and validation reporting.
...
- Codex-specific usage note: keep changes minimal and patch-oriented.
- Keep changes minimal and patch-oriented.
...
- Keep edits inside accepted task scope only.
- Do not modify files outside scope boundaries.
...
- Preserve evidence produced by checks.
- Include marker-based outcomes in final report.
- Report blocked/missing/NOT_RUN/ERROR gate states explicitly.
