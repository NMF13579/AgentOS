...
> Updated: 2026-04-18 (ARCHITECTURE State Control Plane + каноничность)
...
2026-04-18 — **ARCHITECTURE:** в [`ARCHITECTURE.md`](../ARCHITECTURE.md) после потока данных добавлены **State Control Plane** и **Принцип каноничности** (adapter files). См. [`HANDOFF.md`](../HANDOFF.md).
