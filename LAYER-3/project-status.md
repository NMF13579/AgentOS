...
> Updated: 2026-04-18 (state-transitions.md v2)
...
2026-04-18 — **state-transitions:** добавлен [`state-transitions.md`](../LAYER-1/state-transitions.md) — таблицы переходов с Domain, illegal transitions, правила агента и формат Transition Log. См. [`HANDOFF.md`](../HANDOFF.md).
