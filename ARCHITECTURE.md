...
| LAYER-1/audit.md | Документный аудит и **State Consistency Audit** (правила переходов не дублируются — только ссылки на event-dictionary / state-transitions) | Аудит |
