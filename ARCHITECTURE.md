...
- Функциональный слой (LAYER-1) — правила и инструкции, независимые от состояния
- State layer (LAYER-3) — живое состояние: Project, Session, Task
...
- Вся проектная логика живёт в LAYER-1/, LAYER-3/, ARCHITECTURE.md, HANDOFF.md
- Environment adapter files содержат только: порядок bootstrap, ссылки на канонические документы, IDE-specific технические оговорки
- **Правило нового правила:** если логика относится к проекту → идёт в LAYER-1/. Если к конкретной IDE → в adapter file.

### Adapter files в этом репозитории

Следующие файлы являются адаптерами среды и не содержат проектной логики:
- CLAUDE.md
