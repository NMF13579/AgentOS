# Valid Active-Task Proposal Markdown

```json
{
  "active_task_proposal": {
    "proposal_id": "M55_PROPOSAL_READY_MD",
    "proposal_status": "ACTIVE_TASK_PROPOSAL_READY_FOR_REVIEW",
    "source_active_task_readiness_input": "tests/fixtures/active-task-readiness/positive/valid-readiness-input.json",
    ...
    "source_queue_entry": "tasks/queue/valid-ready.md",
    ...
    "proposed_active_task": {
      "task_id": "TASK_ID",
      "title": "PROPOSED_ACTIVE_TASK_TITLE",
      "mode": "EXECUTION",
      "repository": "NMF13579/AgentOS",
      "branch": "dev",
      "source_queue_entry": "tasks/queue/valid-ready.md",
      "proposed_scope_summary": "PROPOSED_SCOPE_SUMMARY",
      "proposed_validation_summary": "PROPOSED_VALIDATION_SUMMARY",
