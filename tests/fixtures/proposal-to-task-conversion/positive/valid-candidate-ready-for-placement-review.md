fixture_name: valid-candidate-ready-for-placement-review
...
conversion_package:
  ...
  source_task_contract_proposal: proposal-005
  proposal_validation_result: TASK_CONTRACT_PROPOSAL_VALIDATED
  source_ux_contract: ux-005
  source_readiness_report: readiness-005
  source_boundary_policy: boundary-005
  source_sections:
    - section-a
  ...
  non_authority_boundary:
    - non-auth-a
  human_authorization_record: auth-005
  conversion_scope: scope-005
  candidate_output: candidate-ready-for-placement-review

human_authorization:
  authorization_id: auth-005
  authorization_type: proposal_to_task_contract_candidate_conversion
  source_proposal: proposal-005
