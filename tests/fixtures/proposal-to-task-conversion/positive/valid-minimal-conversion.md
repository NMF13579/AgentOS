fixture_name: valid-minimal-conversion
...
conversion_package:
  ...
  source_task_contract_proposal: proposal-001
  proposal_validation_result: TASK_CONTRACT_PROPOSAL_VALIDATED
  source_ux_contract: ux-001
  source_readiness_report: readiness-001
  source_boundary_policy: boundary-001
  source_sections:
    - section-a
  ...
  non_authority_boundary:
    - non-auth-a
  human_authorization_record: auth-001
  conversion_scope: scope-001
  candidate_output: candidate-ref-001

human_authorization:
  authorization_id: auth-001
  authorization_type: proposal_to_task_contract_candidate_conversion
  source_proposal: proposal-001
