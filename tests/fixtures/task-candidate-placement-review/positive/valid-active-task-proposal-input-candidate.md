...
type: fixture
scope: positive
name: valid-active-task-proposal-input-candidate
---
...
```json
{
  "placement_review_result": {
    ...
    "eligible_as_m54_active_task_proposal_input": true,
    ...
    "placement_findings": ["Eligible as M54 active-task proposal input candidate."],
    "warnings": [],
    "blockers": [],
    "boundary_flags": {
      "review_only": true,
