...
type: fixture
scope: positive
name: valid-carry-forward-preserved
---
...
```json
{
  "placement_review_result": {
    "result": "PLACEMENT_REVIEW_ELIGIBLE_WITH_LIMITATIONS",
    "exit_code": 0,
    "reviewed": true,
    ...
    "carry_forward": {
      "accepted_limitations": ["Carry-forward accepted limitation preserved."],
      "warnings": ["Carry-forward warning preserved."],
      "open_questions": ["Carry-forward open question preserved."],
      "downstream_limits": ["Carry-forward downstream limit preserved."],
      "known_gaps": ["Carry-forward known gap preserved."],
    ...
    "placement_findings": ["All carry-forward arrays preserved with explicit values."],
    "warnings": ["Eligibility remains conditioned by preserved carry-forward items."],
    "blockers": [],
    "boundary_flags": {
      "review_only": true,
