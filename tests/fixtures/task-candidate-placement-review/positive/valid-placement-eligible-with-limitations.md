...
type: fixture
scope: positive
name: valid-placement-eligible-with-limitations
---
...
```json
{
  "placement_review_result": {
    ...
    "carry_forward": {
      "accepted_limitations": ["M52 limitation carried forward into M53 eligibility review."],
      "warnings": ["Warning preserved for downstream review."],
      "open_questions": [],
      "downstream_limits": [],
      "known_gaps": [],
    ...
    "placement_findings": ["Eligible with carry-forward limitations."],
    "warnings": ["Carry-forward limitations must remain visible."],
    "blockers": [],
    "boundary_flags": {
      "review_only": true,
