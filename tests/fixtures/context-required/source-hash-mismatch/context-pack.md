...
- risk_level: LOW
- affected_paths:
  - tests/fixtures/context-required/source-hash-mismatch/source.md
...
|---|---|---|---|---|---|
| tests/fixtures/context-required/source-hash-mismatch/source.md | policy | canonical | required_when_relevant | Matches fixture task signals. | Follow fixture policy. |
...
- rule: Follow fixture rule
  source: tests/fixtures/context-required/source-hash-mismatch/source.md
...
- selected_source_hashes:
  - tests/fixtures/context-required/source-hash-mismatch/source.md: sha256:deadbeef
- integrity_warnings: []
