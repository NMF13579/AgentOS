...
- risk_level: LOW
- affected_paths:
  - tests/fixtures/context-required/missing-selected-source-file/not-found.md
...
|---|---|---|---|---|---|
| tests/fixtures/context-required/missing-selected-source-file/not-found.md | policy | canonical | required_when_relevant | Matches fixture task signals. | Follow fixture policy. |
...
- rule: Follow fixture rule
  source: tests/fixtures/context-required/missing-selected-source-file/not-found.md
...
- selected_source_hashes:
  - tests/fixtures/context-required/missing-selected-source-file/not-found.md: sha256:abcd
- integrity_warnings: []
