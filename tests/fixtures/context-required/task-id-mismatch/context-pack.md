...
- risk_level: LOW
- affected_paths:
  - tests/fixtures/context-required/valid-context-pack/source.md
...
|---|---|---|---|---|---|
| tests/fixtures/context-required/valid-context-pack/source.md | policy | canonical | required_when_relevant | Matches fixture task signals. | Follow fixture policy. |
...
- rule: Follow fixture rule
  source: tests/fixtures/context-required/valid-context-pack/source.md
...
- selected_source_hashes:
  - tests/fixtures/context-required/valid-context-pack/source.md: sha256:f14dcc9940d1f311a0aadf6bb5c08acfad19d699521c7e2a5ea7d6e9e5fdbc0c
- integrity_warnings: []
