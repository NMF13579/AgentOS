fixture:
  ...
  expected_result: TASK_CONTRACT_CANDIDATE_GENERATION_DRY_RUN_OK
  expected_exit_code: 0
  fixture_cli_mode: dry_run

generator_input:
  input_id: valid-with-limitations
  generator_input_status: GENERATOR_INPUT_READY_WITH_LIMITATIONS
  source_conversion_package: tests/fixtures/task-contract-candidate-generator/sources/valid-conversion-package.md
  ...
  carry_forward:
    accepted_limitations: must-preserve
    open_questions: must-preserve
    downstream_limits: must-preserve
    non_authority_boundary: must-preserve
  boundaries:
