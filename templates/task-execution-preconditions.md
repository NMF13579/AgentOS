...
type: template
milestone: M56
template_for: task-execution-preconditions
status: draft
authority: template
...
This template describes execution preconditions only; it does not authorize execution or M57.

```json
{
  "execution_preconditions": {
    "preconditions_id": "M56_EXECUTION_PRECONDITIONS_ID",
    "preconditions_status": "EXECUTION_PRECONDITIONS_NOT_READY",
    ...
    "required_scope": {
      "scope_present": true,
      "allowed_changes_present": true,
      "forbidden_changes_present": true,
    ...
    "required_validation": {
      ...
      "expected_final_report_present": true,
