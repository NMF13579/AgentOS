...
type: template
milestone: M56
template_for: task-execution-readiness-input
status: draft
authority: template
...
This template describes execution readiness input only; it does not authorize execution or M57.

```json
{
  "execution_readiness_input": {
    "input_id": "M56_EXECUTION_READINESS_INPUT_ID",
    "input_status": "EXECUTION_READINESS_INPUT_DRAFT",
