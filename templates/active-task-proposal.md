...
type: template
milestone: M55
template_for: active-task-proposal
status: draft
authority: template
...
m56_started: false
---
This template describes an active-task proposal only; it does not create or replace tasks/active-task.md.

```json
{
  "active_task_proposal": {
    "proposal_id": "M55_ACTIVE_TASK_PROPOSAL_ID",
    "proposal_status": "ACTIVE_TASK_PROPOSAL_DRAFT",
