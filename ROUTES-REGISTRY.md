...
| adapters | `adapters/MAIN.md` | Adapter routing entry | conditional | legacy-backed | `LAYER-1/adapter-registry.md`, `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`, `DOMAIN-ADAPTER.md`, `scripts/VALIDATORS.md` | Adapter entry and key compatibility constraints are surfaced in `adapters/MAIN.md`; legacy adapter sources and validator policy remain direct-read for full detail |
| quality | `quality/MAIN.md` | Quality/QA routing entry | conditional | transitional | `LAYER-1/testing-guide.md`, `CHECKLIST.md`, `LAYER-2/qa/verification-criteria.md`, `LAYER-2/qa/test-scenarios.md`, `LAYER-1/audit.md`, `LAYER-1/audit-quick.md` | Quality entry and key verification/audit routing are surfaced in `quality/MAIN.md`; legacy sources remain direct-read for full detail |
